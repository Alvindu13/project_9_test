...
public class JournalComptable {
    ...
    public List<SequenceEcritureComptable> getSequenceEcritureComptables() { return sequenceEcritureComptables; }
    public void setSequenceEcritureComptables(List<SequenceEcritureComptable> sequenceEcritureComptables) { this.sequenceEcritureComptables = sequenceEcritureComptables; }
